...
public class LockFreeCOWList<T> {
    ...
    static {
        ...
        try {
            HANDLE = lookup.findVarHandle(LockFreeCOWList.class, "array", Object[].class);
    ...
    public void add(T elem) {
        ...
        while (true) {
            ...
            var updated = Arrays.copyOf(array, size + 1);
            updated[size] = elem;
            if (HANDLE.compareAndSet(this, current, updated)) {
                return;
            }
        }
    }
